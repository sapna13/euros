...
public final class Language implements Serializable {
    ...
    public static HashMap<String, Language> getAllIso639_1Languages(){
    	return byIso639_1;
    }
    ////////////////////////////////////////////////////////////////////////////
    // Language codes defined by ISO 639-1
    ...
    ////////////////////////////////////////////////////////////////////////////
    // Extra mapping for ISO 639-2
    
    private static final HashMap<String,String> iso6392B2T = new HashMap<String,String>();
    
    static {
    	    iso6392B2T.put("sqi","alb");
    	    iso6392B2T.put("hye","arm");
    	    iso6392B2T.put("eus","baq");
    	    iso6392B2T.put("mya","bur");
    	    iso6392B2T.put("zho","chi");
    	    iso6392B2T.put("ces","cze");
    	    iso6392B2T.put("nld","dut");
    	    iso6392B2T.put("fra","fre");
    	    iso6392B2T.put("kat","geo");
    	    iso6392B2T.put("deu","ger");
    	    iso6392B2T.put("ell","gre");
    	    iso6392B2T.put("isl","ice");
    	    iso6392B2T.put("mkd","mac");
    	    iso6392B2T.put("mri","mao");
    	    iso6392B2T.put("msa","mya");
    	    iso6392B2T.put("fas","per");
    	    iso6392B2T.put("ron","rom");
    	    iso6392B2T.put("slk","slo");
    	    iso6392B2T.put("bod","tib");
    	    iso6392B2T.put("cym","wel");
    }
    
    
    // should be b2t not t2b
    private static final HashMap<String,String> iso6392T2B = new HashMap<String,String>();
    
    static {
    	    for(Map.Entry<String,String> b2t : iso6392B2T.entrySet()) {
    	    	    iso6392T2B.put(b2t.getValue(),b2t.getKey());
    	    }
    }
    
    private static final String mapB2T(String bCode) {
    	    if(iso6392T2B.containsKey(bCode) && !bCode.equals("mya") && !bCode.equals("rom")) {
    	    	    return iso6392T2B.get(bCode);
    	    } else {
    	    	    return bCode;
    	    }
    }
    
    private static final String[] iso6392arr = new String[] {
    	    "aar",
    	    "abk",
    	    "ace",
    	    "ach",
    ...
    private static final HashSet<String> iso6392codes = new HashSet<String>();
    
    static {
    	    for(String isoCode : iso6392arr) {
    	    	    iso6392codes.add(isoCode);
    	    }
    }

    private static final boolean isIso639_2(final String code) {
    	    return iso6392codes.contains(code) || (code.length() == 3 &&
    	    	    code.compareTo("qaa") >= 0 && code.compareTo("qtz") <= 0);
    }
    ...
    static {
    	    grandfathered.put("art-lojban","jbo");
    	    grandfathered.put("cel-gaulish","xtg");
    	    grandfathered.put("en-gb-oed","en-GB");
    	    grandfathered.put("i-ami","ami");
    	    grandfathered.put("i-bnn","bnn");
    	    grandfathered.put("i-default","und");
    	    grandfathered.put("i-enochian","mis");
    	    grandfathered.put("i-hak","hak");
    	    grandfathered.put("i-klingon","tli");
    	    grandfathered.put("i-lux","lb");
    	    grandfathered.put("i-mingo","mis");
    	    grandfathered.put("i-navajo","nv");
    	    grandfathered.put("i-pwn","pwn");
    	    grandfathered.put("i-tao","tao");
    	    grandfathered.put("i-tay","tay");
    	    grandfathered.put("i-tsu","tsu");
    	    grandfathered.put("no-bok","nb");
    	    grandfathered.put("no-nyn","nn");
    	    grandfathered.put("sgn-be-fr","sfb");
    	    grandfathered.put("sgn-be-nl","vgt");
    	    grandfathered.put("sgn-ch-de","sgg");
    	    grandfathered.put("zh-guoyu","cmn");
    	    grandfathered.put("zh-hakka","hak");
    	    grandfathered.put("zh-min","zh-TW");
    	    grandfathered.put("zh-min-nan","nan");
    	    grandfathered.put("zh-xiang","hsn");
    }
    ...
    /**
     * Get the ISO 639-2 (T) code. For example, English = "eng", German = "deu",
     * Japanese = "jpn"
     *
     * @return The code or null if there is no code for this language
     */
    ...
    /**
     * Get the ISO 639-2B (Bibliographic code). For example, English = "eng", German = "ger"
     * Japanese = "jpn"
     *
     * @return The code or null if there is no code for this language
     */
     public String getIso639_2B() {
     	     if(iso639_2 != null&& iso6392B2T.containsKey(iso639_2)) {
     	     	     return iso6392B2T.get(iso639_2);
     	     }  else {
     	     	     return iso639_2;
     	     }
     }
    ...
    /**
     * Get an instance of a language by code. This should be used if the language
     * code has region, script, extensions or other elements.
     *
     * @param code The code as an IETF Language tag as defined by RFC 5646.
     * @return The language
    ...
    public static Language get(String code) {
        ...
        if(grandfathered.containsKey(code.toLowerCase())) {
        		code = grandfathered.get(code.toLowerCase());
        }
    ...
    public static Language getByIso639_2(String code) {
        ...
        if (byIso639_2.containsKey(code.toLowerCase())) {
        	...
        	if(isIso639_2(code.toLowerCase()))	 {
        		return new Language(null, null, null, code.toLowerCase(), code.toLowerCase());
        	} else {
        		throw new LanguageCodeFormatException("Unknown ISO 639-2 language code:" + code);
        	}
        }
    }
