...
public final class Region implements Serializable {
    ...
    public static Region getByAlpha2Code(String alpha2code) {
        final Region r = byAlpha2Code.get(alpha2code.toUpperCase());
        if(r == null) {
        	throw new LanguageCodeFormatException("Bad region code: " + alpha2code);
        }
        return r;
    }
    ...
    public static Region getByAlpha3Code(String alpha3code) {
        final Region r =  byAlpha3Code.get(alpha3code.toUpperCase());
        if(r == null) {
        	throw new LanguageCodeFormatException("Bad region code: " + alpha3code);
        }
        return r;
    }
    ...
    public static Region getByNumericCode(int numericCode) {
        final Region r =  byNumericCode.get(numericCode);
        if(r == null) {
        	throw new LanguageCodeFormatException("Bad region code: " + numericCode);
        }
        return r;
    }
